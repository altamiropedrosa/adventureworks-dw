with 
    ...
    ,renamed as (
        ...
        select
            ...
            ,trim(description) as nm_promocao
            ,coalesce(round(cast(discountpct as numeric),3),0.0) as pc_desconto_promocao
            ...
            ,coalesce(cast(minqty as int),0) as qt_minima_promocao
            ,coalesce(cast(maxqty as int),99999) as qt_maxima_promocao
            ,rowguid
